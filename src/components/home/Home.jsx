...
const Home = () => {
  return (
    <section>
      <div
        className="p-screen  grid col-span-0 md:grid-cols-[100px_repeat(2,_1fr)]"
        id="home"
      >
        <div className="h-auto hidden md:items-start justify-center md:flex flex-col md:gap-5 ">
        ...
        <div className="w-auto h-auto col-span-2 md:col-span-1 md:max-h-[520px] pt-10 md:pt-0 flex-col justify-center gap-6 items-center inline-flex md:px-2">
          <div className="self-stretch justify-center items-center inline-flex animate-slideInLeftFast">
            <div className="grow shrink basis-0 text-[10px] text-center text-zinc-900 text-xs md:text-sm font-normal font-['Roboto'] leading-none tracking-wide">
